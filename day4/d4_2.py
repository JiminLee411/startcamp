...
"""
# 1.
for class_one, student in ssafy['classes']['dj'].items():
    if class_one == 'manager':
        print(student[0])
...
"""
# for name, explain in ssafy[]
print(ssafy['languate']['python']['frameworks'])
for framework, description in ssafy['language']['python']['framework'].items():
